 ...
 **
 **
 ** \brief This example demonstrates the process of standbytimer mode.
 **
...
{
    /* set INT00_2 as the input pin of EINT ch.0 P00 */
...
int32_t main(void)
{
    ...
    /* enter Timer mode */
    Lpm_GoToStandByMode(StbTimerMode, TRUE);
    /* wake up open led */
    Gpio_SetIO(2,4,0);
    while(1)
    {
