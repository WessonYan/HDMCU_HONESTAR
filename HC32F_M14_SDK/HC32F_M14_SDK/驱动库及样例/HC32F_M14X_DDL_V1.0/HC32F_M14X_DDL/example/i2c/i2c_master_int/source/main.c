...
/** \file main.c
 **
 ** \brief The example demonstrate i2c master interrupt transmit
 **
...
static void I2cTxCallback(void)
{
    if(stcI2cInfo.enSequence == I2cSeqStart)
    {
        ...
        {
            /* Prepare I2C device address with W flag */
            I2c_SendData(u8I2cCh,((stcI2cInfo.u8DevAddr << 1u)|0u));

            stcI2cInfo.enSequence = I2cSeqWrite;
        }
        else
        {
            /* Prepare I2C device address with R flag */
            I2c_SendData(u8I2cCh,((stcI2cInfo.u8DevAddr << 1u)|1u));
            /* Disable Tx interrupt while reading */
    ...
    else if(stcI2cInfo.enSequence == I2cSeqRestart)
    {
        ...
        I2c_SendData(u8I2cCh, ((stcI2cInfo.u8DevAddr<<1)|1u));

        /* Enable ACK */
        I2c_ConfigAck(u8I2cCh, I2cAck);

        /* Generate I2C start signal */
        if(Ok != I2c_GenerateRestart(u8I2cCh))
        {
        ...
        {
            I2c_DisableIrq(u8I2cCh, I2cTxIrq); /* Disable TX interrupt when read */
        }
    }
