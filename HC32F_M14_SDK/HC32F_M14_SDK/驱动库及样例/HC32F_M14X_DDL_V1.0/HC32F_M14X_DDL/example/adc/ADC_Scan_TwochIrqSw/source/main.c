...
static void ScanIrqHandler(void)
{
    Adc_IrqDisable(ADC_UNIT, AdcIrqScanConv);
    Adc_ClearIrqFlag(ADC_UNIT, AdcIrqScanConv);
...
void Adc_InitConvConfig(void)
{
    ...
    stcAdcIntrpt.stcIsr.pfnIsrScan = ScanIrqHandler;
