...
/** \file main.c
 **
 ** \brief The example for adc range comparison demonstration.
 ...
 ******************************************************************************/
uint8_t u8CmpFinished = FALSE;

/*******************************************************************************
 * Function implementation - global ('extern') and local ('static')
 ******************************************************************************/

static void RangeCmpIrqHandler(void)
{
    Adc_CmpDisable(ADC_UNIT, AdcCmpRange);
    Adc_IrqDisable(ADC_UNIT, AdcIrqRangeCmp);
    Adc_ClearIrqFlag(ADC_UNIT, AdcIrqRangeCmp);
...
void Adc_InitConvConfig(void)
{
    ...
    stc_adc_range_cmp_cfg_t stcAdcRangeCmpCfg;
    ...
    DDL_ZERO_STRUCT(stcAdcRangeCmpCfg);
    DDL_ZERO_STRUCT(stcAdcScanCfg);
    DDL_ZERO_STRUCT(stcAdcSampTimeCfg);
    DDL_ZERO_STRUCT(stcAdcIntrpt);

    /* Configure range comparison. */
    stcAdcRangeCmpCfg.bCmpAllChn = FALSE;
    stcAdcRangeCmpCfg.enCmpChn = AdcChn10;
    stcAdcRangeCmpCfg.enCmpCon = AdcRangeCmpCondOutRange;
    stcAdcRangeCmpCfg.enCmpTimes = AdcRangeCmpTimes3;
    Adc_RangeCmpThrCfg(&stcAdcRangeCmpCfg, 0x300, 0x800);
    ...
    Adc_ScanConvChnCfg(&stcAdcScanCfg, AdcScanChnModeOrder, CHSL(AdcChn10));
    ...
    stcAdcIntrpt.bIrqEnRange= TRUE;
    stcAdcIntrpt.stcIsr.pfnIsrRange = RangeCmpIrqHandler;
    ...
    stcAdcInitCfg.pstcAdcRangeCmpCfg = &stcAdcRangeCmpCfg;
