...
/** \file main.c
 **
 ** \brief The example for adc internal voltage reference demonstration.
...
void Adc_InitConvConfig(void)
{
    ...
    Adc_ScanConvChnCfg(&stcAdcScanCfg, AdcScanChnModeOrder, CHSL(AdcChn9));
    ...
    Adc_ChnSampleTimeCfg(&stcAdcSampTimeCfg, ST1CHN(AdcChn9));
