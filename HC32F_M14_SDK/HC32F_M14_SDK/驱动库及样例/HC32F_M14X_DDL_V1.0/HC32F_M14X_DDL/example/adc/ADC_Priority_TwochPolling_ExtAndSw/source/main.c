...
void Adc_InitConvConfig(void)
{
    ...
    stcAdcPrioCfg.bExtTriggerEn = TRUE;
    stcAdcPrioCfg.bTimerTriggerEn = FALSE;
    stcAdcPrioCfg.enFifoStages = AdcPrioFifoStages2;
    Adc_PrioConvChnCfg(&stcAdcPrioCfg, AdcChn8, AdcChn10);
...
int32_t main(void)
{
    ...
    while (1)
    {
        ...
        Adc_ConvStart(ADC_UNIT, AdcConvPriority);
