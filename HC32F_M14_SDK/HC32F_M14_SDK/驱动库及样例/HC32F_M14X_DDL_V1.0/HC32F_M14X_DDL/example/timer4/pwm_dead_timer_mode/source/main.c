...
/** \file main.c
 **
 ** \brief This example demonstrates how to use the dead timer mode function
 **      of the timer4-pwm.
 **
...
/* Timer4 OCO */
#define OCO_CH_ODD     (TIMER4_OCO_CH1)  /*< Only select TIMER4_OCO_CH1  TIMER4_OCO_CH3  TIMER4_OCO_CH5 */
...
int32_t main(void)
{
    ...
    uint16_t u16OcoOccrVal = CNT_CYCLE_VAL/2;
    ...
    if ((TIMER4_OCO_CH1 == OCO_CH_ODD) || (TIMER4_OCO_CH3 == OCO_CH_ODD) || (TIMER4_OCO_CH5 == OCO_CH_ODD))
    {
        ...
        Timer4_Oco_SetOddChCompareMode(OCO_CH_ODD, &stcOddCmpConfig); /* Configure OCO odd channel compare mode */
    }

    Timer4_Oco_WriteOccr(OCO_CH_ODD, u16OcoOccrVal); /* set OCO odd channel compare value */
    ...
    stcPwmConfig.enMode = PwmDeadTimerMode;
    Timer4_Pwm_Init(u8PwmCoupleCh, &stcPwmConfig); /* Initialize timer4 pwm */
    Timer4_Pwm_WriteDeadRegionValue(u8PwmCoupleCh, 1, u16OcoOccrVal);
