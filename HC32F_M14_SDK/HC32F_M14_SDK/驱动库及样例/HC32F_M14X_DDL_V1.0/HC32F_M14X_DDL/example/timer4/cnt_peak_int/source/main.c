...
/** \file main.c
 **
 ** \brief This example demonstrates how to use the peak interrupt function of
 **      the timer4-cnt.
 **
 ...
 ******************************************************************************/
static uint32_t m_u32PeakIrqCnt = 0;
...
int32_t main(void)
{
    ...
    stcIrqEn.bCntPeakMatchIrq = TRUE;
    stcIrqEn.bCntZeroMatchIrq = FALSE;
    stcIrqCb.pfnCntPeakIrqCb = PeakMatchIrqCb;
    stcIrqCb.pfnCntZeroIrqCb = NULL;

    /* Initialize CNT configuration structure */
    stcCntConfig.enCntClockDiv = CntPclkDiv8;  /* CNT clock divide */
