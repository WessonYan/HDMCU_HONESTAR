...
/** \file main.c
 **
 ** \brief The example for RT function which use io mode4 demonstration
 **
...
int32_t main(void)
{
    ...
    Ct_ConfigIOMode(CT_CH, CtIoMode4);

    /* Set Composite Timer  IO port */
    Gpio_SetFunc_TIOA2_0_OUT(0u);
    Gpio_SetFunc_TIOB2_0_IN(0u);  /* for external trigger */
    ...
    /* Here gernerate falling edge from TIOB2_0 via P00*/
