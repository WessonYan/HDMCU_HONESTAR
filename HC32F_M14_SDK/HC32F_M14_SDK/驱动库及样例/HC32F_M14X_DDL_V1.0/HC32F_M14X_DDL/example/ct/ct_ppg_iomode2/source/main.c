...
/** \file main.c
 **
 ** \brief The example for PPG io mode 2 function demonstration
 **
...
int32_t main(void)
{
    ...
    /* GPIO for external trigger, Need connect P00 to TIOB0_0 before code
       execute */
    ...
    /* Set Main PLL as system clock, when external osc = 4MHz, pclk1 = 16MHz */
    ...
    Gpio_SetFunc_TIOB0_0_IN(0u);  /* for external trigger */

    Gpio_SetFunc_TIOA1_0_OUT(0u);

    /* Set Composite Timer I/O mode */
    Ct_ConfigIOMode(CT_CH, CtIoMode2);
    ...
    stcPpgConfig.enExtTrig = PpgExtTrigFalling;
    ...
    /* Here gernerate falling edge from TIOB0_0 via P00 */
