...
/** \file main.c
 **
 ** \brief This example shows how to use the afd interrupt function of the clock.
 **
 ...
 ******************************************************************************/
static void AfdIrqCb(void);

/*******************************************************************************
 * Local variable definitions ('static')
 ******************************************************************************/
static boolean_t m_bDectedAfd = FALSE;
...
/**
 *******************************************************************************
 ** \brief Afd interrupt callback function
 **
 ** \param [in] None
 **
 ** \retval None
...
static void  AfdIrqCb(void)
{
    Clk_DisableIrq(ClkIrqAfd);
    Clk_DisableFunc(ClkFuncAfd);
    Clk_DisableFunc(ClkFuncAfdReset);
...
int32_t main(void)
{
    ...
    stc_clk_afd_irq_cb_t  stcAfdIrqCb;
    stc_clk_afd_irq_sel_t stcAfdIrqSel;
    ...
    DDL_ZERO_STRUCT(stcAfdIrqCb);
    DDL_ZERO_STRUCT(stcAfdIrqSel);
    ...
    stcAfdIrqSel.bAfdIrqEn = TRUE;
    stcAfdIrqCb.pfnAfdIrqCb = AfdIrqCb;
    stcCsvCfg.enAfdDiv = ClkAfdDiv1024;
    stcCsvCfg.bAfdResetEn = FALSE;
    stcCsvCfg.bAfdEn = TRUE;
    stcCsvCfg.pstcAfdIrqSel = &stcAfdIrqSel;
    stcCsvCfg.pstcAfdIrqCb = &stcAfdIrqCb;
