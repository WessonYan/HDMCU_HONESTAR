...
/** \file main.c
 **
 ** \brief This example shows how to use the cfd reset function of the clock.
 **
...
int32_t main(void)
{
    ...
    stcCsvCfg.bLSXTFailResetEn = TRUE;
    stcCsvCfg.bHSXTFailResetEn = TRUE;
    stcCsvCfg.bLSXTFailDetectEn = TRUE;
    stcCsvCfg.bHSXTFailDetectEn = TRUE;
