...
**
** Auto generate.
** Headerfile for HC32F_M14X series MCU
**
** History:
**
**   - 2017-08-21  1.0   First version for Device Driver Library of HC32F_M14X series MCU.
**
******************************************************************************/

#ifndef __HC32F_M14X_H__
#define __HC32F_M14X_H__
...
typedef struct
{
    ...
    __IO uint16_t LVD                       : 1;
    __IO uint16_t SWWDT                     : 1;
    __IO uint16_t HWWDT                     : 1;
    __IO uint16_t CF                        : 1;
    __IO uint16_t AF                        : 1;
    __IO uint16_t SW                        : 1;
...
{
    uint8_t RESERVED0                       : 5;
    __IO uint8_t SWWDT_BRK                  : 1;
    uint8_t RESERVED6                       : 1;
    __IO uint8_t HWWDT_BRK                  : 1;
...
} stc_parity_parity_ctl_field_t;

typedef struct
{
    __IO uint32_t ADDR                      :32;
} stc_parity_parity_addr_field_t;
...
} stc_vc_vc_ctl2_field_t;

typedef struct
{
    __IO uint8_t VC_TM0G                    : 1;
    __IO uint8_t VC_TM2G                    : 1;
} stc_vc_vc_ctl3_field_t;
...
typedef struct
{
    ...
    {
        __IO uint8_t CTSSSR;
        stc_ctsssr_ctsssr_field_t CTSSSR_f;
    };
}M0P_CTSSSR_TypeDef;
...
typedef struct
{
    union
    {
        ...
        stc_opa_opa_ctl_field_t OPA_CTL_f;
    };
}M0P_OPA_TypeDef;
...
typedef struct
{
    union
    {
        ...
        stc_parity_parity_ctl_field_t PARITY_CTL_f;
    };
    uint8_t RESERVED1[3];
    union
    {
        __IO uint32_t PARITY_ADDR;
        stc_parity_parity_addr_field_t PARITY_ADDR_f;
    };
}M0P_PARITY_TypeDef;
...
typedef struct
{
    union
    {
        ...
        stc_vc_vc_ctl1_field_t VC_CTL1_f;
    };
    uint8_t RESERVED1[3];
    union
    {
        __IO uint16_t VC_CTL2;
        stc_vc_vc_ctl2_field_t VC_CTL2_f;
    };
    uint8_t RESERVED2[2];
    union
    {
        __IO uint8_t VC_CTL3;
        stc_vc_vc_ctl3_field_t VC_CTL3_f;
    };
}M0P_VC_TypeDef;
...
#define M0P_FLASH_BASE        (0x00000000UL)                 /* Flash Base                             */
#define M0P_CM0P_BASE         (0xE0000000UL)                 /* CM0P Private                           */
#define M0P_PERIPH_BASE       (0x40000000UL)                 /* Peripheral Base                        */

#define M0P_FLASH_IF_BASE     (M0P_PERIPH_BASE + 0x00000UL)  /* Flash interface registers              */
#define M0P_UNIQUE_ID_BASE    (M0P_PERIPH_BASE + 0x00100UL)  /* Unique ID registers                    */
#define M0P_CLOCK_BASE        (M0P_PERIPH_BASE + 0x10000UL)  /* Clock and reset registers              */
#define M0P_HWWDT_BASE        (M0P_PERIPH_BASE + 0x11000UL)  /* Hardware watchdog registers            */
#define M0P_SWWDT_BASE        (M0P_PERIPH_BASE + 0x12000UL)  /* Software watchdog registers            */
#define M0P_DTIM1_BASE        (M0P_PERIPH_BASE + 0x15000UL)  /* Dual timer 1 registers                 */
#define M0P_DTIM2_BASE        (M0P_PERIPH_BASE + 0x15020UL)  /* Dual timer 2 registers                 */
#define M0P_TIME4_BASE        (M0P_PERIPH_BASE + 0x20000UL)  /* Timer 4 registers                      */
#define M0P_CT0_PPG_BASE      (M0P_PERIPH_BASE + 0x25000UL)  /* Composite Timer 0 PPG registers        */
#define M0P_CT0_PWM_BASE      (M0P_PERIPH_BASE + 0x25000UL)  /* Composite Timer 0 PWM registers        */
#define M0P_CT0_RT_BASE       (M0P_PERIPH_BASE + 0x25000UL)  /* Composite Timer 0 RT registers         */
#define M0P_CT0_PWC_BASE      (M0P_PERIPH_BASE + 0x25000UL)  /* Composite Timer 0 PWC registers        */
#define M0P_CT1_PPG_BASE      (M0P_PERIPH_BASE + 0x25040UL)  /* Composite Timer 1 PPG registers        */
#define M0P_CT1_PWM_BASE      (M0P_PERIPH_BASE + 0x25040UL)  /* Composite Timer 1 PWM registers        */
#define M0P_CT1_RT_BASE       (M0P_PERIPH_BASE + 0x25040UL)  /* Composite Timer 1 RT registers         */
#define M0P_CT1_PWC_BASE      (M0P_PERIPH_BASE + 0x25040UL)  /* Composite Timer 1 PWC registers        */
#define M0P_CT2_PPG_BASE      (M0P_PERIPH_BASE + 0x25080UL)  /* Composite Timer 2 PPG registers        */
#define M0P_CT2_PWM_BASE      (M0P_PERIPH_BASE + 0x25080UL)  /* Composite Timer 2 PWM registers        */
#define M0P_CT2_RT_BASE       (M0P_PERIPH_BASE + 0x25080UL)  /* Composite Timer 2 RT registers         */
#define M0P_CT2_PWC_BASE      (M0P_PERIPH_BASE + 0x25080UL)  /* Composite Timer 2 PWC registers        */
#define M0P_CT3_PPG_BASE      (M0P_PERIPH_BASE + 0x250C0UL)  /* Composite Timer 3 PPG registers        */
#define M0P_CT3_PWM_BASE      (M0P_PERIPH_BASE + 0x250C0UL)  /* Composite Timer 3 PWM registers        */
#define M0P_CT3_RT_BASE       (M0P_PERIPH_BASE + 0x250C0UL)  /* Composite Timer 3 RT registers         */
#define M0P_CT3_PWC_BASE      (M0P_PERIPH_BASE + 0x250C0UL)  /* Composite Timer 3 PWC registers        */
#define M0P_CTIOSEL03_BASE    (M0P_PERIPH_BASE + 0x25100UL)  /* Composite Timer I/O selector channel 0 - channel 3 registers */
#define M0P_CTSSSR_BASE       (M0P_PERIPH_BASE + 0x25F00UL)  /* Software based Simulation Startup (Composite Timer) register */
#define M0P_ADC0_BASE         (M0P_PERIPH_BASE + 0x27000UL)  /* 12-bit ADC unit 0 registers            */
#define M0P_OSC_BASE          (M0P_PERIPH_BASE + 0x2E000UL)  /* OSC control registers                  */
#define M0P_EXTINT_BASE       (M0P_PERIPH_BASE + 0x30000UL)  /* External interrupt registers           */
#define M0P_IRQC_BASE         (M0P_PERIPH_BASE + 0x31000UL)  /* Interrupt request read registers       */
#define M0P_LCDC_BASE         (M0P_PERIPH_BASE + 0x32000UL)  /* LCD Controller registers               */
#define M0P_GPIO_BASE         (M0P_PERIPH_BASE + 0x33000UL)  /* General purpose I/O registers          */
#define M0P_WSUNIT_BASE       (M0P_PERIPH_BASE + 0x35000UL)  /* WS Unit registers                      */
#define M0P_MSC4_UART_BASE    (M0P_PERIPH_BASE + 0x37000UL)  /* UART asynchronous channel 4 registers  */
#define M0P_MSC4_SPI_BASE     (M0P_PERIPH_BASE + 0x37000UL)  /* UART synchronous channel 4 registers   */
#define M0P_MSC4_I2C_BASE     (M0P_PERIPH_BASE + 0x37000UL)  /* I2C channel 4 registers                */
#define M0P_MSC5_UART_BASE    (M0P_PERIPH_BASE + 0x37100UL)  /* UART asynchronous channel 5 registers  */
#define M0P_MSC5_SPI_BASE     (M0P_PERIPH_BASE + 0x37100UL)  /* UART synchronous channel 5 registers   */
#define M0P_MSC5_I2C_BASE     (M0P_PERIPH_BASE + 0x37100UL)  /* I2C channel 5 registers                */
#define M0P_MSC6_UART_BASE    (M0P_PERIPH_BASE + 0x37200UL)  /* UART asynchronous channel 6 registers  */
#define M0P_MSC6_SPI_BASE     (M0P_PERIPH_BASE + 0x37200UL)  /* UART synchronous channel 6 registers   */
#define M0P_MSC6_I2C_BASE     (M0P_PERIPH_BASE + 0x37200UL)  /* I2C channel 6 registers                */
#define M0P_CLOCKCOUNTER_BASE (M0P_PERIPH_BASE + 0x3A000UL)  /* Clock counter registers                */
#define M0P_PARITY_BASE       (M0P_PERIPH_BASE + 0x3C000UL)  /* Parity check registers                 */
#define M0P_PCG_BASE          (M0P_PERIPH_BASE + 0x3C100UL)  /* Peripheral Clock Gating registers      */
#define M0P_VC_BASE           (M0P_PERIPH_BASE + 0x3C300UL)  /* Voltage comparator registers           */
#define M0P_OPA0_BASE         (M0P_PERIPH_BASE + 0x3C400UL)  /* Operation amplifier 0 registers        */
#define M0P_OPA1_BASE         (M0P_PERIPH_BASE + 0x3C480UL)  /* Operation amplifier 1 registers        */
#define M0P_DMAC_BASE         (M0P_PERIPH_BASE + 0x60000UL)  /* DMAC register                          */
#define M0P_MTBDWT_BASE       (0xF0001000UL)                 /* MTB-DWT registers                      */
#define M0P_FASTIO_BASE       (0xF8000000UL)                 /* Fast GPIO                              */

#define M0P_ADC                                ((M0P_ADC_TypeDef*)M0P_ADC0_BASE)
#define M0P_CLOCK                              ((M0P_CLOCK_TypeDef*)M0P_CLOCK_BASE)
#define M0P_CLOCK_COUNTER                      ((M0P_CLOCK_COUNTER_TypeDef*)M0P_CLOCKCOUNTER_BASE)
#define M0P_CTIOSEL03                          ((M0P_CTIOSEL03_TypeDef*)M0P_CTIOSEL03_BASE)
#define M0P_CTSSSR                             ((M0P_CTSSSR_TypeDef*)M0P_CTSSSR_BASE)
#define M0P_CT0_PPG                            ((M0P_CT_PPG_TypeDef*)M0P_CT0_PPG_BASE)
#define M0P_CT1_PPG                            ((M0P_CT_PPG_TypeDef*)M0P_CT1_PPG_BASE)
#define M0P_CT2_PPG                            ((M0P_CT_PPG_TypeDef*)M0P_CT2_PPG_BASE)
#define M0P_CT3_PPG                            ((M0P_CT_PPG_TypeDef*)M0P_CT3_PPG_BASE)
#define M0P_CT0_PWC                            ((M0P_CT_PWC_TypeDef*)M0P_CT0_PWC_BASE)
#define M0P_CT1_PWC                            ((M0P_CT_PWC_TypeDef*)M0P_CT1_PWC_BASE)
#define M0P_CT2_PWC                            ((M0P_CT_PWC_TypeDef*)M0P_CT2_PWC_BASE)
#define M0P_CT3_PWC                            ((M0P_CT_PWC_TypeDef*)M0P_CT3_PWC_BASE)
#define M0P_CT0_PWM                            ((M0P_CT_PWM_TypeDef*)M0P_CT0_PWM_BASE)
#define M0P_CT1_PWM                            ((M0P_CT_PWM_TypeDef*)M0P_CT1_PWM_BASE)
#define M0P_CT2_PWM                            ((M0P_CT_PWM_TypeDef*)M0P_CT2_PWM_BASE)
#define M0P_CT3_PWM                            ((M0P_CT_PWM_TypeDef*)M0P_CT3_PWM_BASE)
#define M0P_CT0_RT                             ((M0P_CT_RT_TypeDef*)M0P_CT0_RT_BASE)
#define M0P_CT1_RT                             ((M0P_CT_RT_TypeDef*)M0P_CT1_RT_BASE)
#define M0P_CT2_RT                             ((M0P_CT_RT_TypeDef*)M0P_CT2_RT_BASE)
#define M0P_CT3_RT                             ((M0P_CT_RT_TypeDef*)M0P_CT3_RT_BASE)
#define M0P_DMAC                               ((M0P_DMAC_TypeDef*)M0P_DMAC_BASE)
#define M0P_DTIM1                              ((M0P_DTIM_TypeDef*)M0P_DTIM1_BASE)
#define M0P_DTIM2                              ((M0P_DTIM_TypeDef*)M0P_DTIM2_BASE)
#define M0P_EXTINT                             ((M0P_EXTINT_TypeDef*)M0P_EXTINT_BASE)
#define M0P_FASTIO                             ((M0P_FASTIO_TypeDef*)M0P_FASTIO_BASE)
#define M0P_FLASH_IF                           ((M0P_FLASH_IF_TypeDef*)M0P_FLASH_IF_BASE)
#define M0P_GPIO                               ((M0P_GPIO_TypeDef*)M0P_GPIO_BASE)
#define M0P_HWWDT                              ((M0P_HWWDT_TypeDef*)M0P_HWWDT_BASE)
#define M0P_IRQC                               ((M0P_IRQC_TypeDef*)M0P_IRQC_BASE)
#define M0P_LCDC                               ((M0P_LCDC_TypeDef*)M0P_LCDC_BASE)
#define M0P_MSC4_I2C                           ((M0P_MSC_I2C_TypeDef*)M0P_MSC4_I2C_BASE)
#define M0P_MSC5_I2C                           ((M0P_MSC_I2C_TypeDef*)M0P_MSC5_I2C_BASE)
#define M0P_MSC6_I2C                           ((M0P_MSC_I2C_TypeDef*)M0P_MSC6_I2C_BASE)
#define M0P_MSC4_SPI                           ((M0P_MSC_SPI_TypeDef*)M0P_MSC4_SPI_BASE)
#define M0P_MSC5_SPI                           ((M0P_MSC_SPI_TypeDef*)M0P_MSC5_SPI_BASE)
#define M0P_MSC6_SPI                           ((M0P_MSC_SPI_TypeDef*)M0P_MSC6_SPI_BASE)
#define M0P_MSC4_UART                          ((M0P_MSC_UART_TypeDef*)M0P_MSC4_UART_BASE)
#define M0P_MSC5_UART                          ((M0P_MSC_UART_TypeDef*)M0P_MSC5_UART_BASE)
#define M0P_MSC6_UART                          ((M0P_MSC_UART_TypeDef*)M0P_MSC6_UART_BASE)
#define M0P_MTB_DWT                            ((M0P_MTB_DWT_TypeDef*)M0P_MTBDWT_BASE)
#define M0P_OPA0                               ((M0P_OPA_TypeDef*)M0P_OPA0_BASE)
#define M0P_OPA1                               ((M0P_OPA_TypeDef*)M0P_OPA1_BASE)
#define M0P_OSC_CTL                            ((M0P_OSC_CTL_TypeDef*)M0P_OSC_BASE)
#define M0P_PARITY                             ((M0P_PARITY_TypeDef*)M0P_PARITY_BASE)
#define M0P_PCG                                ((M0P_PCG_TypeDef*)M0P_PCG_BASE)
#define M0P_SWWDT                              ((M0P_SWWDT_TypeDef*)M0P_SWWDT_BASE)
#define M0P_TIMER4                             ((M0P_TIMER4_TypeDef*)M0P_TIME4_BASE)
#define M0P_UID                                ((M0P_UID_TypeDef*)M0P_UNIQUE_ID_BASE)
#define M0P_VC                                 ((M0P_VC_TypeDef*)M0P_VC_BASE)
#define M0P_WSUNIT                             ((M0P_WSUNIT_TypeDef*)M0P_WSUNIT_BASE)
...
#define bM0P_CLOCK_STAT_SWWDT                           *((volatile unsigned int*)(0x42200190UL))
#define bM0P_CLOCK_STAT_HWWDT                           *((volatile unsigned int*)(0x42200194UL))
...
#define bM0P_CLOCK_DBWDT_CTRL_SWWDT_BRK                 *((volatile unsigned int*)(0x42200A94UL))
#define bM0P_CLOCK_DBWDT_CTRL_HWWDT_BRK                 *((volatile unsigned int*)(0x42200A9CUL))
...
#define bM0P_GPIO_FN7_P76                               *((volatile unsigned int*)(0x42660398UL))
...
#define bM0P_GPIO_PU7_P76                               *((volatile unsigned int*)(0x42662398UL))
...
#define bM0P_GPIO_DIR7_P76                              *((volatile unsigned int*)(0x42664398UL))
...
#define bM0P_GPIO_GET7_P76                              *((volatile unsigned int*)(0x42666398UL))
...
#define bM0P_GPIO_SET7_P76                              *((volatile unsigned int*)(0x42668398UL))
...
#define bM0P_GPIO_ODR7_P76                              *((volatile unsigned int*)(0x4266E398UL))
...
#define bM0P_GPIO_FSETE7_P76                            *((volatile unsigned int*)(0x42672398UL))
...
#define bM0P_IRQC_IRQ_ST02_HWWDT                        *((volatile unsigned int*)(0x42620204UL))
#define bM0P_IRQC_IRQ00PEND_AFDI                        *((volatile unsigned int*)(0x42620280UL))
#define bM0P_IRQC_IRQ01PEND_SWWDT                       *((volatile unsigned int*)(0x42620300UL))
